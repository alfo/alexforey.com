...
?>
  ...
  <div class="about-me">
    ...
    <div class="container">
      ...
      <p>I'm an <?php echo $age; ?>-year-old lighting designer, associate, programmer, and technician. I have been working in professional theatre since 2016 across all scales of theatre, from 50-seat fringe venues to the West End. I begin studying at the Royal Academy of Dramatic Art in September 2019.</p>
      ...
      <p>As assistant lighting designer: <i>Growl</i> (Tour: Theatre Royal Bury St Edmunds, Curve Leicester, Rose Theatre Kingston).</p>

      <p>As programmer: <i>Nature of Why</i> (Queen Elizabeth Hall, Souhtbank Centre), <i>Quintessential</i> (Peacock Theatre, Sadler’s Wells).</p>
